...
//#define CAMERA_CARD_NAME		"USB Device 0x46d:0x825"// logitec C270  // not used anymore
//#define CAMERA_CARD_NAME		"USB Device 0x46d:0x819"// logitec C210
